...
curl 'localhost/elparking/controllers/readChange_plato.php?id_plato=29'
curl 'localhost/elparking/controllers/delete_plato.php' -X DELETE -d '{"id_plato":"3"}' -H 'Content-Type: application/json'
